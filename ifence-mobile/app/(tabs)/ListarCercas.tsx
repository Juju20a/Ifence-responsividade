      ...
      <View style={[styles.container, { backgroundColor: colors.background }]}>
        <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
          ...
          <View style={[styles.formContainer, { backgroundColor: colors.infoBox }]}>
            ...
            {showInicioPicker && (
              <DateTimePicker value={horarioInicio} mode="time" is24Hour={true} display="default" onChange={onChangeInicio} />
            )}
            ...
            {showFimPicker && (
              <DateTimePicker value={horarioFim} mode="time" is24Hour={true} display="default" onChange={onChangeFim} />
            )}

            <View style={styles.buttonsRow}>
              <TouchableOpacity style={[styles.button, { backgroundColor: colors.button, marginRight: 10 }]} onPress={handleCriar}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={true} style={{ flexGrow: 0, backgroundColor: colors.infoBox }}>
            <View style={{ minWidth: width * 0.9, flex: 1 }}>
              {loading ? (
        ...
        <CercaModal visible={modalVisible} onClose={() => setModalVisible(false)} onSave={handleSalvar} cercaParaEditar={cercaEditando} />
      </View>
      <Toast />
    </>
  );
